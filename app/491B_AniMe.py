...
def create_app(config_file):
	...
	db.animeDB.import_csv_animes("backend/kaggle/testanime.csv", batch_size = 5000)
	db.reviewDB.import_csv_reviews("backend/kaggle/testrating.csv", batch_size = 100000)
